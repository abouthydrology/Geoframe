...
public class PArea {
    ...
    static String workingDirectory="/Users/riccardo/Dropbox/A-Workspace/ARPaper2013";
    private static TCA tca;
    
	public static void main(String[] args) throws EsriAsciiHeaderException, EofException {
		
		System.out.println("This is PArea main()");
		for(int i=1;i < 129;i++){
			//Creating the right name ... it could become a variable to read from a file
			String thisName=workingDirectory+File.separator+i+File.separator+i+"_S_OCN_tca.asc";
			//reading the file
		...
		String pA=workingDirectory+File.separator+"2S-AreaDistribution.txt";
		TextIO.writeFile(pA);
		//Writing the File
