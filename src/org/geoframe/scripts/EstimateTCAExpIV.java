 ...
 *
 */
public class EstimateTCAExpIV {
 
	public static void main(String[] args) {
		
		System.out.println("This is EstimateTCAExpIV main()");
        double ee;
        String workingDirectory="/Users/riccardo/Dropbox/A-Workspace/ARPaper2013-IV";
