 ...
 *
 */
public class VariableInjectionExperiment {
	...
	public static void main(String[] args) throws EsriAsciiHeaderException, EofException {
		...
		InfoFolder workingFolder=new InfoFolder(relativeWorkingPath+File.separator+"ARPaper2013-II");
...
//		System.out.println("The name of the file is "+workingFolder.shortName);
    ...
    //Reads the weights
	String weightsFileName="/Users/riccardo/Dropbox/A-Workspace/ARPaper2013-II/weights20-20.asc";
