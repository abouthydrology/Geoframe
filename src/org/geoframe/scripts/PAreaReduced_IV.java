...
public class PAreaReduced_IV {
	...
	static final int L=16326+1;
    static double[] pArea=new double[L];
    static String workingDirectory="/Users/riccardo/Dropbox/A-Workspace/ARPaper2013-IV";
    private static Field tca;
    
	public static void main(String[] args) throws EsriAsciiHeaderException, EofException {
		
		System.out.println("This is PAreaReduced_IV main()");
		for(int i=1;i < 129;i++){
		...
		String pA=workingDirectory+File.separator+"R-AreaDistribution-IV.txt";
		TextIO.writeFile(pA);
		//Writing the File
