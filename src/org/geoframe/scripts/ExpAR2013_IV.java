...
/*	public ExperimentAR2013(Flow basin,TCA area){
	...
	//a file
	public ExpAR2013_IV(String basinName,String areaName){
...
// This becomes interesting when the program is long and the main should become itself very long and complex	
	...
	public static  ExpAR2013_IV initialize(int netno){
	
	//Gets the file names for inputs	
	String name="/Users/riccardo/Dropbox/A-WorkSpace/ARPaper2013-IV";
	...
	ExpAR2013_IV experiment=new ExpAR2013_IV(basinName,tcaName);
	...
	experiment.arExp.pIterations=3000000;
...
*/
  ...
  public void experimentDeploy(){
	...
	public static void main(String[] args) {
		System.out.println("This is ExpAR2013_IV main");
		//Below is the number of networks to process
		String wFile="/Users/riccardo/Dropbox/A-WorkSpace/ARPaper2013-IV/ARExperiment.init";
