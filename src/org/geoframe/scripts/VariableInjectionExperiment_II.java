...
import org.geoframe.ocn.EstimateRealTCA;
 ...
 *
 */
public class VariableInjectionExperiment_II {
	...
	public static void main(String[] args) throws EsriAsciiHeaderException, EofException {
		...
		System.out.println("This is VariableInjection main()");
		InfoFolder workingFolder=new InfoFolder(relativeWorkingPath+File.separator+"ARPaper2013-III");
...
//		System.out.println("The name of the file is "+workingFolder.shortName);
	...
	//Field wghts=new Field(130,130);
    //Reads the weights
	String weightsFileName="/Users/riccardo/Dropbox/A-Workspace/ARPaper2013-III/weights_30_30.asc";
	Field wghts = Field.asciiRasterReader(weightsFileName);
	EstimateRealTCA bTCA=new EstimateRealTCA(edenBasinFlow,wghts);
	//bTCA.area.print();
