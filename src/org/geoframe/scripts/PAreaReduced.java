...
public class PAreaReduced {
	...
	public static void main(String[] args) throws EsriAsciiHeaderException, EofException {
		...
		System.out.println("This is PAreaReduced main()");
		for(int i=1;i < 128;i++){
		...
		String pA=workingDirectory+File.separator+"R-AreaDistribution-II.txt";
		TextIO.writeFile(pA);
		//Writing the File
